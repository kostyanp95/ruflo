...
// Resolution order:
// 1. node_modules/@claude-flow/cli (npm install / npm link)
// 2. ../cli/ (self-contained repo layout — clone from kostyanp95/ruflo)
// 3. ../../v3/@claude-flow/cli (monorepo layout — D:\ruflo dev environment)
const cliBase = pkgDir
  ? join(pkgDir, 'node_modules', '@claude-flow', 'cli')
  : existsSync(resolve(__dirname, '..', 'cli', 'dist', 'src', 'index.js'))
